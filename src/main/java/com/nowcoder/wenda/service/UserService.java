...
public class UserService implements WendaConstant {
    ...
    public Map<String, Object> register(User user) {
        ...
        // 注册用户
        user.setSalt(WendaUtil.generateUUID().substring(0, 5));
        user.setPassword(WendaUtil.md5(user.getPassword() + user.getSalt()));
        user.setType(0);
        user.setStatus(0);
        user.setActivationCode(WendaUtil.generateUUID());
        ...
        // http://localhost:8080/wenda/activation/153/1f1191d5505940bd888c97053408aee9
